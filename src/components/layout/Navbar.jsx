...
export default function Navbar() {
  ...
  return (
    <header className="w-full bg-white sticky top-0 z-50 shadow-md">
      ...
      {/* Moving Ticker Bar */}
      <div className="w-full bg-[#0057b2] text-white py-2.5 overflow-hidden border-b border-white/20">
        <div className="animate-scroll">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="flex items-center gap-8 px-8 whitespace-nowrap text-[11px] md:text-xs font-mono font-medium">
              ...
              <span className="text-[#7ed957] font-bold tracking-widest ml-2">REC: #69741</span>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          {/* Left Side: SPeCS Logo */}
          <div className="w-full md:w-1/4 flex justify-between items-center md:justify-start">
            <img src="/specs.png" alt="SPeCS Logo" className="h-16 lg:h-20 w-auto object-contain" />
